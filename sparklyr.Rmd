...
conf <- spark_config_kubernetes(
  master = "k8s://https://35.223.203.139", # Type kubectl cluster-info to get this url.
  version = "3.3",
...
sc <- spark_connect(
  config = conf,
  spark_home = "/opt/spark/3.3.0" # Use the folder where Spark was installed by install-spark.sh
)
```
